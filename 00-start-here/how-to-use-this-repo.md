...
## Local publishing packs
Use `10-local-export-guides/publishing-pack-convention.md` when moving approved repo work into local folders for final images, captions, publishing assets, and post archives. GitHub stays the source of truth for Markdown/CSV planning files; local exports are for heavy or platform-ready production assets.
